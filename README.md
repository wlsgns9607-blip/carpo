...
> 조기 점검과 예방 교체를 통해 모두가 안전하고 당당하게 도로 위를 달릴 수 있도록 도우려 합니다. 저는 그래서 '카싱크'를 만들었습니다.
...
*   🎙 **DRIVER**
    *"하이 카싱크, AI 카싱크 실행해 줘. 어? 브레이크 밟을 때마다 끼익거리는 쇳소리가 나네?"*
...
# 🏛️ [카싱크] 정비소 탐색 및 견적 요청 UX/UI 개선 기획서

## 1. 개요 및 배경
* **서비스:** 카싱크 (자동차 정비 및 관리 플랫폼)
...
* **유저 신뢰도 제고:** 카싱크 자체 브랜딩 강화 및 불필요한 타사 이동 감쇄.
...
# 🏛️ [카싱크 / 세차의 정석] 외제차 정밀 견적 및 평가 기반 상위 랭킹 시스템 기획서
